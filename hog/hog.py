...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        num_rolls = strategy0(score0, score1) if who == 0 else strategy1(score0, score1)
        points = take_turn(num_rolls, score1 if who == 0 else score0, dice)
        score0 += points if who == 0 else 0
        score1 += points if who == 1 else 0
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(current_score0, current_score1):
        ...
        if gain > 0 and gain > running_high:
            running_high = gain
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for num_rolls in range(1, 11):
        ...
        average_score = total_score / trials_count
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    free_bacon_points = free_bacon(opponent_score)
    extra = extra_turn(player_score=free_bacon_points+score, opponent_score=opponent_score)
    if free_bacon_points >= cutoff or extra:
        return 0
    else:
        return num_rolls
    # Replace this statement
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    free_bacon_points = free_bacon(opponent_score)
    if free_bacon_points >= 8:
        return 0
    if swine_align(score, opponent_score):
        return 0
